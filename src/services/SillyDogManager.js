...
const url = "https://silly-dog-api.netlify.app/sillyDogs";
...
const savePageContent = async (pageContent, sillyDogId) => {
  const url = `https://silly-dog-api.netlify.app/sillyDogs/${sillyDogId}/pagecontent`;
...
const getPageContent = async (sillyDogId) => {
  const url = `https://silly-dog-api.netlify.app/${sillyDogId}/pagecontent`;

  ...
  return (
    <div className="silly-dog-display">
      ...
      <div className="aliases-relatives">
        <p>
          <strong>Aliases:</strong> {dummyDog.aliases.join(", ")}
        </p>
        <p>
          <strong>Relatives:</strong> {dummyDog.relatives.join(", ")}
        </p>
      </div>
      <p>
      ...
      <div className="bio-info">
        <p>
          <strong>Date of Death:</strong> {dummyDog.dateOfDeath}
        </p>
        <p>
          <strong>Place of Death:</strong> {dummyDog.placeOfDeath}
        </p>
      </div>
      <p>
